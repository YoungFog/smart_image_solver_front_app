<template>
    <view class="content">
        <u--text type="primary" text="选择要加密的PDF文件" size='20' :bold='true'
        ...
        <u--text type="primary" text="设置密码" size='20' :bold='true'
        ...
        <textarea class="bigbox" v-model="text" style="margin-left: 6%;margin-right: 6%;width:300px;height: 80px; padding: 20px; font-size: 30upx; color: #808080;"
         placeholder="请输入您要设置的密码" placeholder-style="color: #d1d1d1"></textarea>
         
         <u--text type="primary" text="对加密后的文件重命名" size='20' :bold='true'
         style='padding-left: 6%;padding-top: 2%;'></u--text>
        ...
        <u-button  @click="gotoEn" size="large" type="primary" shape="circle" text="开 始 加 密" style='width: 50%;margin-top: 30px;'></u-button>
        ...
        word-break: break-all;'>
            <u-row><u--text type="primary" text="已成功加密文件" size='20' :bold='true'
        ...
        gotoEn(){
            ...
            if (this.path == "暂未选择文件") {
            	...
            	pathToBase64(this_temp.path)
            		.then(base64 => {
            			uni.request({
            				url: this_temp.serverUrl + 'lock',
            				method: 'POST',
            				header: {
            					'content-type': 'application/x-www-form-urlencoded'
            				},
            				data: {
            					ori_pdf: base64.split(',')[1],
